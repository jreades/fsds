...
![](https://github.com/jreades/i2p/raw/master/img/casa_logo.jpg){width:100}
...
**Task 6** will help you to understand <i>how</i> to build your own classes in greater detail, but it is enough to understand that classes exist in hierarchies (as this was also covered in the live session).

<div class="alert alert-block alert-warning">
    <b>&#9888; Important</b>: This is a very long practical and it's <em>not</em> expected that you will get through it in the alloted time.
</div> 

<div class="alert alert-block alert-success">
    <b>&#128161; Group Sign-Up</b>: You should now make it a priority <a href="https://forms.office.com/e/2ij0sWHnpR">Sign Up</a>!
</div>
...
<div class="alert alert-block alert-info">
    <b>&#128279; Connections</b>: This task briefly recaps the final part of <a href="https://jreades.github.io/fsds/sessions/week3.html#practical">Practical 2</a> and builds on the <a href="https://jreades.github.io/fsds/sessions/week3.html#lectures">DOLs to Data</a> and <a href="https://jreades.github.io/fsds/sessions/week3.html#lectures">Functions</a> lectures.
</div>
...
<div class="alert alert-block alert-success">
    <b>Difficulty level</b>: Low (this time around).
</div>
...
### Task 2.1 Calculate Mean & Std Dev

<div class="alert alert-block alert-success">
    <b>Difficulty level</b>: Low-ish.
</div>
...
### Task 2.2 For Loops Without For Loops
...
### Task 3.1: Downloading from a URL
...
<div class="alert alert-block alert-success">
    <b>Difficulty level</b>: Low, if you've watched the videos...
</div>
...
<div class="alert alert-block alert-warning">
    <b>Difficulty level</b>: Medium, if you really explore what's going on in the function rather than just running it and moving on.
</div>
...
### Task 3.3: Convert the CSV into a DoL
...
#### 4.1.2 A Function to Convert Data Types
...
### Task 4.2: Checking Basic Functionality
...
### Task 4.3 Was it Worth It?

<div class="alert alert-block alert-success"><b>Difficulty level</b>: Low, it should just <em>work</em>.</div>
...
<div class="alert alert-block alert-info">
    <b>&#128279; Connections</b>: This is building on both <a href="https://jreades.github.io/code-camp/lessons/Functions.html">Functions</a> and <a href="https://jreades.github.io/code-camp/lessons/Packages.html">Packages</a> sessions from Code Camp as well as the <a href="https://jreades.github.io/fsds/sessions/week3.html#lectures">Functions</a> and <a href="https://jreades.github.io/fsds/sessions/week3.html#lectures">Packages</a> lectures. 
</div>
...
<div class="alert alert-block alert-info">
    <b>&#128279; Connections</b>: This will draw on what you've learned in the lectures about <a href="">Methods</a>, <a href="">Classes</a>, and <a href="">Design</a>. You will also find the Code Camp <a href="https://jreades.github.io/code-camp/lessons/Classes.html">Classes</a> session useful.</div>
