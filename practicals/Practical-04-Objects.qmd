...
**Task 6** will help you to understand *how</i> to build your own classes in greater detail, but it is enough to understand that classes exist in hierarchies (as this was also covered in the live session).

::: {.callout-warning}

    **&#9888; Important**: This is a very long practical and it's _not_ expected that you will get through it in the alloted time.
::: 

::: {.callout-tip}

    **&#128161; Group Sign-Up**: You should now make it a priority [Sign Up](https://forms.office.com/e/2ij0sWHnpR)!
:::
...
::: {.callout-note}
    ...
    **&#128279; Connections**: This task briefly recaps the final part of [Practical 2](https://jreades.github.io/fsds/sessions/week3.html#practical) and builds on the [DOLs to Data](https://jreades.github.io/fsds/sessions/week3.html#lectures) and [Functions](https://jreades.github.io/fsds/sessions/week3.html#lectures) lectures.
:::


# (Revisited). Why 'Obvious' is Not Always 'Right'
...
::: {.callout-warning}
    ...
    **Difficulty level**: Medium, if you really explore what's going on in the function rather than just running it and moving on.
:::
...
::: {.callout-tip}
**Difficulty level**: Low, as I've provided a function.
...
::: {.callout-tip}
**Difficulty level**: Low, it should just _work_.
