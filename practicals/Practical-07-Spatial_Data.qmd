...
We're building on the work done in [Practical 5](Practical-06-Numeric_Data.qmd) and [Practical 4](Practical-05-Objects.qmd) (with a particular nod to the [lecture on Data](https://jreades.github.io/fsds/sessions/week5.html#lectures)) to create some useful functions that we can call on at-need to improve the ease of doing data analysis.
