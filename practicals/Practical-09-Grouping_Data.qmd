...
::: {.callout-warning}
    ...
    **Difficulty level**: Moderate, though you might find the questions hard.
:::
...
::: {.callout-warning}
    ...
    **Difficulty level**: Moderate since, conceptually, there's a lot going on.
:::
...
::: {.callout-caution}
    ...
    **Difficulty level**: Hard, as I've left out quite a bit of code.
:::
