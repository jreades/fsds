...
::: {.callout-note}
**Note**: the `&lt;package_name&gt;.__version__` approach isn't guaranteed to work with _every_ package, but it will work with most of them. Remember that variables and methods starting and ending with '`__`' are **private** and any interaction with them should be approached very, very carefully.
...
#### Difficulty: Moderate; although the code here is simple, but the logic is not.
...
#### Difficulty: Hard. There is a _lot_ going on here and you should be paying close attention.
