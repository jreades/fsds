...
```python
print("The position of '`{python} listings[1]`' in the list is: " + str( ?? ))
```
...
```python
print("The nightly price for `{python} f'{listing}'` is £" + str(prices[2]) + ".")
# ...OR...
listing=2
print("The nightly price for `{python} f'{listing}'` is £" + str(prices[listing[2]]) + ".")
```
