...
::: {.callout-tip}
    ...
    In this section you'll need to look up (i.e. Google) and make use of a few new functions that apply to dictionaries: `&lt;dictionary&gt;.items()`, `&lt;dictionary&gt;.keys()`. *Remember</i>: if in doubt, add `print(...)` statements to see what is going on!
...
::: {.callout-tip}
    ...
    I just want you to think about these *as data</i>! If you were trying to use `cities` and `cities_alt` as data what differences would you find when accessing one or more 'records'?
