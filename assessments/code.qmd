...
## Reproducibility 
 ...
 To ensure reproducibility, markers must be able to select `Kernel` > `Restart Kernel and Run All Cells...` and **reproduce your _entire analysis_**. This includes downloading and extracting data, cleaning, transformation, clustering... charts, tables, etc. If you need to provide supplementary or partially-processed data then you can provide this via Dropbox, OneDrive (public sharing link), or some other *robust* cloud solution that will be accessible from the marker's system.
:::
