...
- A [template](https://github.com/jreades/fsds/blob/master/assessments/Group_Work.qmd) shou
ld be used, though you are free to modify this template as needed.  You can see both [PDF](Group_Work.pdf) and [HTML](Group_Work.html) output, but please *only* submit the PDF!
