...
2. [Collaboratively evaluating and analysing a data set](./group.qmd) ({{< var assess.group-weight >}}) as a group you will be determining the suitability of a data set for tackling an analytical 'problem' using a mix of coding, analysis, *and* presentation skills in a reproducible format {{< var assess.group-date >}} @ {{< var assess.group-time >}});
3. [Reflecting on the process](./individual.qmd) ({{< var assess.peer-weight >}}) to better-understand *why* a project succeeded/failed so as to improve future outcomes and recognise the contributions of individual members of the group to the success of the project (due {{< var assess.peer-date >}} @ {{< var assess.peer-time >}}).
