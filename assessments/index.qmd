...
3. [Reflecting on the process](./peer.qmd) ({{< var assess.peer-weight >}}) to better-understand *why* a project succeeded/failed so as to improve future outcomes and recognise the contributions of individual members of the group to the success of the project (the self-evaluation component is due {{< var assess.peer1-date >}} @ {{< var assess.peer1-time >}} and your peer ratings are due {{< var assess.peer2-date >}} @ {{< var assess.peer2-time >}}).
