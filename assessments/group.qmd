...
1. Its **reproducibility** ({{< var assess.group-code-weight >}} of this assessment): do the analyses employed, and outputs created by the group run fully and without errors on a different computer.
