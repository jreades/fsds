...
## Start with a Chart (Part 2)

Building on [Week 7](./7.4-Signal_and_Noise.qmd), here are some deeper links between models and visualistions:
...
![](./img/safe_to_swim.jpg){alt="A sign showing the average fish size is 10cm, but the reality under the water is a lot of 5cm fish and a very large shark."}

::::
:::

::: {.aside}
This section was inspired by this: [When Averages Lie](https://towardsdatascience.com/when-averages-lie-moving-beyond-single-point-predictions-23201e8c04c8/)
:::

## What are We Modelling?

<h3 style="margin-top: 200px;"><blockquote>Exploratory, predictive, and causal modelling have very different bases.</blockquote></h3> 
...
<h3 style="margin-top: 200px;"><blockquote>Depending on how we conceptualise and tackle 'error', our models will differ. Often dramatically.</blockquote></h3> 

## What isn't Fitting?

<h3 style="margin-top: 200px;"><blockquote>This is why we care about leverage and skew; not because we *need* normality, but because they impact model quulity.</blockquote></h3> 
...
- [Axis Styles](https://seaborn.pydata.org/generated/seaborn.axes_style.html#seaborn.axes_style): includes `darkgrid`, `whitegrid`, `dark`, `white`, `ticks`.


## Anatomy of a Figure

![](https://matplotlib.org/_images/sphx_glr_anatomy_001.png){height="500"}

::: {.aside}

Source: [Matplotlib documentation](https://matplotlib.org/gallery/showcase/anatomy.html#anatomy-of-a-figure).
...
This feature [has many options](https://matplotlib.org/stable/gallery/mplot3d/index.html) though you'll not get QGIS-quality output:
...
::: {.aside}
You can also set the elevation and azimuth using: `ax.view_init(<elevation>, <azimuth>)`.
:::
...
![](img/Matplotlib_Widget.png){height="500"}
