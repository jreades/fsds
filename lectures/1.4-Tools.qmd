...
<h1>But <strong>why</strong> would we want this?</h1>
</div>
...
## Two Basic 'Flavours' {.smaller}

Both do the *same* thing: separate the platform from the hardware, but they do this in different ways for different reasons.
...
![](./img/Podman-logo.png){style="width:85%;fig-align:left" alt="Podman logo"}
...
8. `stash` changes that we don't want to commit.
9. `status` the repository.
