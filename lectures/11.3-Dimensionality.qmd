...
![](https://umap-learn.readthedocs.io/en/latest/_images/SupervisedUMAP_33_0.png)
...
::: {.notes}
see examples on [umap-learn.readthedocs.io](https://umap-learn.readthedocs.io/en/latest/parameters.html)
:::
