...
# *To Do*: discuss how your team can work together effectively.^[Once you've formed your team, obvs!]

::: {.notes}

So you'll want to revisit this lecture once the group assignments are finalised. But it seems sensible to talk about it now rather than wait until you're already trying, and potentialy failing, to work together.

:::

## Go Groups!

![Group Signup Form](./img/QRCode for CASA0013 Group Signup (25_26).png)

Or: [use the link](https://forms.microsoft.com/e/G4H3Jynz5J).
