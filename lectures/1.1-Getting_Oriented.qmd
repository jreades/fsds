...
2. Moodle: [{{< var module.moodle-short >}}]({{< var module.moodle >}}) -- recorded sessions, booking drop-in hours, group messaging, quizzes,  'answer sheets', and submission of assessments, as well as other core, formal module components.
