...
I've tried to throw together some _ideas_ on [how you can study effectively](../attention.qmd) that covers things relating to managing distractions when you've only got limited time. 

There's also useful ideas on [how to get help](../help.qmd) that covers things like 'how to get a reply from your Prof' and 'where to look for help'.
