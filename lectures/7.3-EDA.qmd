...
## What Can We Do?^[This is by no means all that we can do...] (Series)
...
## What Can We Do?^[*Hint*: there's a lot more we could do!] (Data Frame Edition) 

+----------------------+------------------------------------------+
| Command              | Returns                                  |
+======================+==========================================+
| ```python            | ```                                      |
| print(df.mean())     | Mean of each *numerical* column          |
