...
![](https://sd.keepcalms.com/i-w600/lets-get-this-party-started-4.jpg){fig-alt="Let's Get This Party Started" fig-align="middle"}
...
Let's go back to the [Lists](2.5-Lists.qmd) examples for a second:
...
## A Debugging Manifesto!^[[Source](https://twitter.com/b0rk/status/1570060516839641092)]

![](./img/debugging_manifesto-b0rk_twitter.jpg){fig-alt="A debugging manifesto" fig-align="middle" height=500}
