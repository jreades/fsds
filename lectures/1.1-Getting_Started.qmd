...
- **Self- and Peer-Evaluation**: is a Moodle 'IPAC' assessment due {{< var assess.peer1-date >}} (Part 1) *and* {{< var assess.peer2-date >}} (Peer 2) combining short individual reflection combined with numerical scoring and free-text comments by peers on your contribution to the group's outcomes.
...
- [Slack]({{< var module.slack >}})^[Here's the [signup link](https://join.slack.com/t/casa-students-2025-26/shared_invite/zt-3d8l6zhpf-ElfIf9bUaQn3b1NcNljqBA). You *must* use your UCL address.]
...
You will get things wrong. We will get things wrong. We have tried to offer suggestions for [how to read]({{< var module.sds >}}skills/reading.html), [how to think about what you're learning]({{< var module.sds >}}skills/thinking.html}}), and how to [manage distractions]({{< var module.sds >}}skills/attention.html). But if you [need help]({{< var module.sds >}}skills/help.html) we are here for you!
...
![ACC QR Code](./img/acc.png){width=200}
