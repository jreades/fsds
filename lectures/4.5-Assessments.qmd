...
:::: {.columns}
::: {.column width="50%"}
[[forms.microsoft.com/e/u0zZ8grLC2](https://forms.microsoft.com/e/u0zZ8grLC2)]{style="font-size: smaller;"}

![](./img/QRCode\ for\ Continuous\ Module\ Feedback\ \(Checkpoint\ 1\).png){fig-alt="Continuous Module Feedback Checkpoint 1"}
:::
::: {.column width="50%"}
[[forms.microsoft.com/e/G4H3Jynz5J](https://forms.microsoft.com/e/G4H3Jynz5J)]{style="font-size: smaller;"}

![](./img/QRCode\ for\ CASA0013\ Group\ Signup\ (25_26).png){fig-alt="Group Signup Form"}
:::
::::
