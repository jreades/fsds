...
Any concept *up to and including Week 5* is 'fair game' but we will not ask about the use of Git/GitHub or Docker. The exam will consist of *no more* than 15 questions.^[So, roughly, that means about 8 minutes/question.] 
