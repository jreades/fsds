...
Shift from computers as processors of data **to integrated, pervasive systems** that generate data on *everything*.

#### Wave 3

- Roughly the mid-2000s–?
- Computers as tools for **generating data** (*pace*^[*Pace* is "a softener for very formal politeness: it means that the person you are about to name would probably disagree what what you are about say or do, but you mean no offense to that person." [Explanation](https://ell.stackexchange.com/questions/43593/what-is-the-meaning-of-the-word-pace)] ABM researchers)
...
I’m not totally happy about my description of Wave 3 and will try to dig into this in a little more detail but suggestions are welcome!
...
According to @Donoho:2017, 'data science' differs from 'statistics' through an interest in:
