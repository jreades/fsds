...
## All Kinds of Features {.smaller}

JupyterLab is basically a web application and, as such, has all kinds of features:

+++
![](./img/lab/Lab-Interface.png)
+++
![](./img/lab/Lab-Extensions.png)
+++
![](./img/lab/Notebook-Structure.png)
