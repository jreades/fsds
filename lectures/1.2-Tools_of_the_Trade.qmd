...
1. **Dropbox** (or OneDrive): keep your stuff backed up in the cloud.
...
## Dropbox/OneDrive {.smaller}

![](./img/Dropbox.png)

Dropbox and OneDrive are 'cloud-based file synchronisation tools': files placed in the special folder are automatically uploaded to servers, and automatically downloaded to any _other_ computer on which you have set up the service. Changes are also synchronised 'every time' you save the file.

## Why Use It?

We want you to use Dropbox and/or OneDrive for four reasons:
