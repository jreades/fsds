...
- Understanding of the DGP (*Data Generating Process*).
  - Where does data come from and how is it generated?
...
- Real-world Spatial Data Science is not easy.
...
How I made use of AI in this module:

:::{.incremental}
1. CoPilot for auto-completion of some code/documentation.
2. ChatGPT for generating rubrics and testing questions.
3. NotebookLM for creating study guides.
