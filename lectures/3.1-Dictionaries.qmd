...
```{python}
cities2 = {}  # Empty dictionary
cities2['Beijing'] = 21716620    # Sets key->value
cities2['Toronto'] = 2930000     # Sets key->value

print(f"Toronto population is {cities2['Toronto']:,}")
del cities2['Toronto']           # Deletes Toronto key (and value)
print(f"Pop: {cities2.pop('Toronto','Default')}") 
print(cities2)
```
