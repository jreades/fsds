...
> In *most* programming languages dictionaries/hashes are **unordered**: there is no guarantee that things come out in the same order they went in! They **complement** ordered lists, they don't **replace** them!
