...
- Use of non-existent or irrelevant references/coding libraries.^[This has even fueled security vulnerabilities in code using 'slopsquatting'!]
::: 
...
- Deluge of bullshit [@Bergstrom:2025]
::: 
...
- [Modern-Day Oracles or Bullshit Machines?](https://thebullshitmachines.com/index.html)
...
::: 
::: {.column width="50%"}
- [‘How can I know what I think till I see what I say?’: How AI is changing education and writing](https://www.hepi.ac.uk/2025/03/26/how-can-i-know-what-i-think-till-i-see-what-i-say-how-ai-is-changing-education-and-writing/)
- [What does it mean if students think that AI is more intelligent than they are?](https://wonkhe.com/blogs/what-does-it-mean-if-students-think-that-ai-is-more-intelligent-than-they-are/)
