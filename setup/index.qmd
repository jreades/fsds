...
Once you've ticked off the Requirements, you can start installing the tools that you will use to write and run both code and documentation. You will need set up [Git and GitHub](https://jreades.github.io/sds_env/setup/git.html) in order to manage, share, and version code. To write documentation and comments on code you will be want a [Markdown](https://jreades.github.io/sds_env/setup/markdown.html) editor and to familiarise yourself with Markdown's syntax. And, finally, you will need to install the [programming environment](https://jreades.github.io/sds_env/setup/env.html) or (as an emergency backup if you aren unable to get your hands on a machine that meets the basic requirements of the module) work with the ['no install' options](https://jreades.github.io/sds_env/setup/no_install.html).
