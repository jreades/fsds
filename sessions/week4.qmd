...
1. What are the two conflicting geographical imaginations at play in contemporary society? Explain their contradictory nature.
2. In the case study of 'high-tech' scientists, how do the 'power geometries' of work and home reflect gendered power relations?
...
1. What does the "view from nowhere" concept mean in the context of data visualization, and why do they find it problematic?
2. How do they propose to address the limitations of data visualization? Describe their concept of "data visceralization" and its significance.
3. Why do they suggest that you shouldn't *never* use the 'god trick'?

With reference to Smith's "Valuing housing and green spaces":

1. How is the hedonic modelling method used to understand the relationship between green spaces and house prices?
2. Does this approach respect some of the positional aspects developed in the other readings, or is just another 'view from nowhere'? 
