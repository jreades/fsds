...
2. Looking at D'Ignazio and Klein's "On Rational, Scientific, Objective Viewpoints from Mythical, Imaginary, Impossible Standpoints":
...
These are two of the more challenging readings this term, but they are critical to understanding what we are trying to teach you: it's *not* just about learning to code, it's about learning how to deploy code/quantitative methods to *support* your argument, while maintaining a keen eye on how bias -- in both the technical and the ethical senses -- can creep into your thinking and, consequently, your results! In fact, the point would be that we are *always* biased one way or another, it's just that many of us don't stop to reflect on what that bias -- or positionality -- actually is.
...
| Session | Video | Presentation    | 
| :------ | :---- | :-------------- | 
| Group Working |   In class | [Slides](../lectures/{{< meta week >}}.4-Group_Working.qmd)      |
| The Assessments | In class | [Slides](../lectures/{{< meta week >}}.5-Assessments.qmd) |
