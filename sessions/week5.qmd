...
| More on the Assessments | In class | [Slides](../lectures/5.5-Assessments.qmd) | 
...
Two more readings about the impact of Airbnb on cities [@Wachsmuth:2018;@Harris:2018] that you're likely to find useful for developing your thinking for the [Group Work](../assessments/group.qmd) and one by @dignazio:2020 to highlight the importance of thinking about what a data set captures... and what it excludes. You should almost *never* be claiming that your (social) data represents the 'universe' of behaviours or is somehow 'complete'.
