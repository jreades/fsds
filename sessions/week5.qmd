...
@Etherington:2016 will hopefully help you to see how spatial and programming concepts can be connected to one another to improve our understanding of *both*, and for a particularly good example of this see the *GIS Algorithms* text [@xiao:2016]. 
