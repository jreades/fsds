...
| :------ | :---- | :----------- | :---- |
| Computers in Urban Studies | In Class | [Slides](../lectures/2.1-Computers_in_Planning_and_Geography.qmd) | [Notes]() |
| Principles of Programming | In Class | [Slides](../lectures/2.2-Principles_of_Programming.qmd) | [Notes]() |
| Python: the Basics | [Video]({{< var vids.basics >}}) | [Slides](../lectures/2.3-Python_the_Basics.qmd) | [Notes]() |
| Lists | [Video]({{< var vids.lists >}})  | [Slides](../lectures/2.4-Lists.qmd) | [Notes]() |
| Iteration| [Video]({{< var vids.iteration >}}) | [Slides](../lectures/2.5-Iteration.qmd) | [Notes]() |
| The Command Line | [Video]({{< var vids.cli >}}) | [Slides](../lectures/2.6-The_Command_Line.qmd) | [Notes]() |
| Getting Stuck Into Git | [Video]({{< var vids.git >}}) | [Slides](../lectures/2.7-Git.qmd) | [Notes]() |
...
- [ ] Reviewing Python variables
- [ ] Reviewing Python operators
- [ ] Reviewing Python conditions/logic
- [ ] Reviewing Python lists
- [ ] Demonstrating the power of the command line
...
The practical can be [downloaded from GitHub]({{< var module.raw >}}/practicals/Practical-02-Foundations_1.ipynb).
