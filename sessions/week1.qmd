...
- [ ] Getting you up and running with coding and collaboration tools.
...
If you have already installed the programming environment then the practical can be [downloaded from GitHub](https://github.com/jreades/fsds/blob/master/practicals/Practical-01-Getting_Started.ipynb). 

Since there is no code to run this week, you can also [view it online](https://github.com/jreades/fsds/blob/master/practicals/Practical-01-Getting_Started.ipynb) in your web browser.
