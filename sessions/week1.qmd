...
In the first week we will be focussing on the supporting infrastructure for 'doing data science'. That is to say, we'll be dealing with the installation and configuration of tools such as GitHub and Podman which support replicable, shareable, and document-able data science. As a (free) bonus, the use of these tools also protects you against catastrophic (or the merely irritating) data loss thanks to over-zealous editing of code or content. You should see this as preparing the foundation not only for your remaining CASA modules (especially those in Term 2) but also for your post-MSc career.
...
1. Drawing on @ArribasBel:2018, compare and contrast GIS, Geocomputation, and Geographical Data Science (GDS):
...
2. Still drawing on @ArribasBel:2018, consider the role of technological determinism in the evolution of geographical thought:
