...
If you have already installed the programming environment then the practical can be [downloaded from GitHub]({{< var module.raw >}}practicals/Practical-01-Getting_Started.ipynb). 
